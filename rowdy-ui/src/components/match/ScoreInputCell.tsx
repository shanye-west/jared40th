        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          ...
          {circleCount >= 2 && (
            <div
              ...
              style={{ width: '38px', height: '38px', borderWidth: '2px', borderColor: isPostMatch ? '#cbd5e1' : '#000000', borderStyle: 'solid' }}
            />
          )}
          {circleCount >= 3 && (
            <div
              className="absolute rounded-full"
              style={{ width: '42px', height: '42px', borderWidth: '2px', borderColor: isPostMatch ? '#cbd5e1' : '#000000', borderStyle: 'solid' }}
            />
          )}
          {circleCount >= 4 && (
            <div
              className="absolute rounded-full"
              style={{ width: '46px', height: '46px', borderWidth: '2px', borderColor: isPostMatch ? '#cbd5e1' : '#000000', borderStyle: 'solid' }}
            />
          )}
          {/* Inner circle for birdie (always shown when under par) */}
          <div
            className="absolute rounded-full"
            style={{ width: '34px', height: '34px', borderWidth: '2px', borderColor: isPostMatch ? '#cbd5e1' : '#000000', borderStyle: 'solid' }}
          />
        </div>
      )}
      {hasStroke && (
